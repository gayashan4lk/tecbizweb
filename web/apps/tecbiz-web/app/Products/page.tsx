...
const ProductsPage: React.FC = () => {
  return (
    <div className="bg-black py-16 text-white text-center">
      <h1 className="text-2xl md:text-4xl lg:text-6xl font-semibold mb-4 text-blue-100 hover:text-blue-400 transition duration-300">Discover Our Extraordinary Products</h1>
