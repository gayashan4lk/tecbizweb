  ...
  return (
    <div className="bg-black text-white">
      <div className="max-w-4xl mx-auto text-center py-24">
        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-blue-200 hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="text-3xl md:text-3xl font-bold text-center mb-8">BESPOKE WEB 2.0 DEVELOPMENT</h2>
          ...
          <a href="#" className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition duration-200">
            Contact Us
          </a>
        </div>

        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-blue-200 hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="text-3xl md:text-3xl font-bold  text-center mb-8">AI CHATBOT DEVELOPMENT</h2>
          <p className="text-xl md:text-xl font-semibold text-center mb-8">
        ...
        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-blue-200 hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="text-3xl md:text-3xl font-bold  text-center mb-8">PYTHON-BASED APPLICATION DEVELOPMENT</h2>
          <p className="text-xl md:text-xl font-semibold text-center mb-8">
