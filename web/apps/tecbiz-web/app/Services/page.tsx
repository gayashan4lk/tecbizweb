    ...
    <div className="bg-black text-white">
      <div className="max-w-4xl mx-auto text-center py-24">
        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-black hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="text-3xl md:text-3xl lg:text-5xl font-semibold mb-4 text-blue-200 hover:text-blue-300 transition duration-300">BESPOKE WEB 2.0 DEVELOPMENT</h2>
        ...
        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-black hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="text-3xl md:text-3xl lg:text-5xl font-semibold mb-4 text-blue-200 hover:text-blue-300 transition duration-300">AI CHATBOT DEVELOPMENT</h2>
          <p className="text-xl md:text-xl font-semibold text-center mb-8">
        ...
        <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-black hover:text-blue-900 transition duration-700 transform hover:scale-105">
          <h2 className="ttext-3xl md:text-3xl lg:text-5xl font-semibold mb-4 text-blue-200 hover:text-blue-300 transition duration-300">PYTHON-BASED APPLICATION DEVELOPMENT</h2>
          <p className="text-xl md:text-xl font-semibold text-center mb-8">
