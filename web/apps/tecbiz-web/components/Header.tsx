...
const Header: React.FC = () => {
  return (
    <header className="bg-gray-900 py-4 md:py-6 lg:py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 md:mb-0">
          TechBizSolution
        </h1>
        <nav className="md:flex space-x-6 text-white text-lg">
          <Link href="/Home">
            ...
            <ul className="absolute hidden text-white bg-gray-900 space-y-2 py-2 rounded-lg group-hover:block">
              <li>
                <Link href="/services/A">
                  <span className="hover:text-blue-500 cursor-pointer">A</span>
                </Link>
              </li>
              <li>
                <Link href="/services/B">
                  <span className="hover:text-blue-500 cursor-pointer">B</span>
                </Link>
              </li>
              <li>
                <Link href="/services/C">
                  <span className="hover:text-blue-500 cursor-pointer">C</span>
                </Link>
              </li>
              {/* Add more */}
            </ul>
