...
const VissionMission: React.FC = () => {
  return (
    <section className="py-12 bg-black"> {/* Update background color */}
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-6 bg-black rounded-lg shadow-md text-blue-100 hover:bg-blue-300 hover:text-blue-900 transition duration-700 transform hover:scale-90">
