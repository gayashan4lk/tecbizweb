  ...
  return (
    <section className="bg-hero-pattern bg-black bg-cover bg-center py-16 md:py-24 lg:py-32 text-center text-black">
      <div className="container mx-auto">
        <h1 className="text-2xl md:text-4xl lg:text-6xl font-semibold mb-4 text-white hover:text-blue-500 transition duration-300">
          Empowering Individuals & Achieve Excellence Through Professional Opportunities And AI Innovation.
        </h1>
        <h2 className="text-xl md:text-3xl lg:text-5xl font-semibold mb-4 text-white hover:text-blue-500 transition duration-300">
          Your Solution for Tech Needs
        </h2>
        <p className="text-base md:text-lg lg:text-xl mb-8 text-white hover:text-gray-700 transition duration-300">
