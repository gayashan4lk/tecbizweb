  ...
  return (
    <section className="bg-hero-pattern bg-black bg-cover bg-center py-32 md:py-16 lg:py-32 text-center text-black">
      <div className="container mx-auto">
        ...
        <p className="text-base md:text-lg lg:px-8 mb-8 text-white hover:text-blue-900 transition duration-300">
          We provide innovative tech solutions for your business.
        </p>
        <button className="bg-blue-300 hover:bg-blue-900 text-white px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 rounded-full text-lg lg:px-8 transition duration-300 hover:text-white hover:shadow-md">
          Get Started
        </button>
      </div>
    </section>
