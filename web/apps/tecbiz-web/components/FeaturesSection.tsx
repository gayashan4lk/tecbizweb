...
const FeaturesSection: React.FC = () => {
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-black   text-center text-black">
      ...
      <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold mb-4 text-blue-100 hover:transform hover:scale-105 transition-transform duration-500">
        ...
        <div className="text-center mb-8">
          <h3 className="text-base md:text-lg lg:px-8 font-medium text-white hover:text-blue-900 transition duration-700">
